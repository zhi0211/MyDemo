...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff0000ff;
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		 ...
		 WheelActivity.mHandler.sendEmptyMessage(1001);
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val);//选择条的颜色
		}
