...
public class RockerView extends SurfaceView implements Callback, Runnable {
	...
	//固定摇杆背景圆形的X,Y坐标以及半径
	private static final int INIT_ROCKER_CIRCLE_X = 100;
	private static final int INIT_ROCKER_CIRCLE_Y = 100;

	private int RockerCircleX = INIT_ROCKER_CIRCLE_X;
	private int RockerCircleY = INIT_ROCKER_CIRCLE_Y;
	private int RockerCircleR = 50;
	//摇杆的X,Y坐标以及摇杆的半径
	private float SmallRockerCircleX = INIT_ROCKER_CIRCLE_X;
	private float SmallRockerCircleY = INIT_ROCKER_CIRCLE_Y;
	...
	public boolean onTouchEvent(MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN ||
			...
			SmallRockerCircleX = INIT_ROCKER_CIRCLE_X;
			SmallRockerCircleY = INIT_ROCKER_CIRCLE_Y;
		}
		return true;
	}
