...
public class DetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_detail_layout);

        position = getIntent().getIntExtra("pos", 0);
        actor = MaterialActivity.actors.get(position);
        ...
        getActionBar().setTitle(MaterialActivity.actors.get(position).name);
