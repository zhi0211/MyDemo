...
//	private Typeface typeface;
	...
	private void initPainter() {
		...
		textPaint.setTextSize(textSize / 5);
...
//				"fonts/digit.TTF");
	...
	public void draw(Canvas canvas) {
		canvas.drawText(String.format("%.0f", value), centerX - correction,
				(centerY) + marginTop, digitPaint);
		canvas.drawText(units, centerX + textSize * 0.9f - correction,
				(centerY) + marginTop, textPaint);
	}
