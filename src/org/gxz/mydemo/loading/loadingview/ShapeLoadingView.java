...
public class ShapeLoadingView extends View {
	...
	private void init() {
		mTriangleColor = getResources().getColor(R.color.loading_triangle);
		mCircleColor = getResources().getColor(R.color.loading_circle);
		mRectColor = getResources().getColor(R.color.loading_rect);
		mPaint = new Paint();
		mPaint.setColor(mTriangleColor);
		mPaint.setAntiAlias(true);
		mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
		setBackgroundColor(getResources().getColor(R.color.loading_view_bg));
