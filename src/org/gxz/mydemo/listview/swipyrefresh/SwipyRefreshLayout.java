...
public class SwipyRefreshLayout extends ViewGroup {
	...
	public SwipyRefreshLayout(Context context, AttributeSet attrs) {
		...
		final int colorsId = a.getResourceId(R.styleable.SwipyRefreshLayout_refresh_colors, 0);
		final int colorId = a.getResourceId(R.styleable.SwipyRefreshLayout_refresh_color, 0);
		...
		if (colorsId > 0) {
			...
			colors = new int[]{Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)};
		}

		if (colorId > 0) {
			colors = new int[]{context.getResources().getColor(colorId)};
		}
		a2.recycle();
		final DisplayMetrics metrics = getResources().getDisplayMetrics();
	...
	private void createProgressView(int... colors) {
