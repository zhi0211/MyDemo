...
import org.gxz.mydemo.widgets.SwitchButton;
...
public class SlideBoxPreference extends android.preference.CheckBoxPreference {
	private Context mContext;
	private int mLayoutResId = R.layout.prefs_checkedbox_middle;
	...
	public SlideBoxPreference(Context context, AttributeSet attrset, int defStyle) {
		super(context, attrset);
		mContext = context;
		mSummaryOn = getSummaryOn();
		mSummaryOff = getSummaryOff();
		mAccessibilityManager = (AccessibilityManager) mContext.getSystemService(Service.ACCESSIBILITY_SERVICE);
	}

	public SlideBoxPreference(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.checkBoxPreferenceStyle);
	}

	public SlideBoxPreference(Context context) {
		this(context, null);
	}
	...
	protected View onCreateView(ViewGroup parent) {
		...
		mLayoutResId = getLayoutResource();
	...
	protected void onBindView(View view) {
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(mContext, "点击了" + getTitle(), 0).show();
			}
		});
		...
		if (checkboxView != null && checkboxView instanceof Checkable) {
			...
			if (mSendAccessibilityEventViewClickedType && mAccessibilityManager.isEnabled() && checkboxView.isEnabled()) {
