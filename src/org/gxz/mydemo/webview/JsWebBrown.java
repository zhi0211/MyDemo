...
public class JsWebBrown extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myWebView.setWebViewClient(new WebViewClient(){
			...
			public void onPageFinished(WebView view, String url) {
				Log.d(JsWebBrown.class.getCanonicalName(), "onPageFinished!!!!!!!!!!");
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				Log.d(JsWebBrown.class.getCanonicalName(), "shouldOverrideUrlLoading!!!!!!!!!!");
...
//				return super.shouldOverrideUrlLoading(view, url);
		...
		myButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String str = "Hello!!";
				String str2 = "HI!!";
				myWebView.loadUrl("javascript:myFunction('"+str+"','"+str2+"')");
	...
	// 注入js函数监听
		private void addImageClickListner() {
			...
			myWebView.loadUrl("javascript:(function(){"
					...
					+ "         var value = getData(this.src); "
					+ "        myInterfaceName.openImage(value);  "
					+ "    }  " + "}" + "})()");
		}
	...
	public class WebAppInterface {
		...
		public void showToast(String toast) {
			Log.d(JsWebBrown.class.getCanonicalName(),"showToast:"+toast);
			// Toast.makeText(mContext, toast, Toast.LENGTH_SHORT).show();
			Toast.makeText(mContext, "showToast:"+toast, Toast.LENGTH_LONG).show();
		}
		
		
		@JavascriptInterface
		public void openImage(String text){
			Log.d(JsWebBrown.class.getCanonicalName(),"openImage:"+text);
			Toast.makeText(mContext, "openImage:"+text, Toast.LENGTH_LONG).show();
		}
	}
